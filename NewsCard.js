...
const NewsCard = ({ article: { description, publishedAt, source, title, url, urlToImage }, activeArticle, i }) => {
    ...
    }, []);//C:\Users\AUSTIN\Downloads\Hackathon\healthylife\src\components\NewsCard\NewsCard.js
    ...
    //https://indepreneur.io/wp-content/uploads/2018/10/sQUARE.jpg
    return (
        <Card ref={elRefs[i]} className={activeArticle === i ? classes.activeCard : classes.card}>
            <CardActionArea href={url} target="_blank">;
                <CardMedia className={classes.media} image={urlToImage || 'https://indepreneur.io/wp-content/uploads/2018/10/sQUARE.jpg'} title={title} />
